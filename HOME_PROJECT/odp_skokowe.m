...
y1(1:k_step) = 0; y2(1:k_step) = 0; y3(1:k_step) = 0; y4(1:k_step) = 0;
u(1:k_step-1) = 0;
...
stairs(y2, 'DisplayName','u_s_k_o_k = -0.5')
stairs(y3, 'DisplayName','u_s_k_o_k = 0.5')
stairs(y4, 'DisplayName','u_s_k_o_k = 1')
